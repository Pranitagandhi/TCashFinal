...
public class SignupController {
	...
	public ModelAndView save2(@ModelAttribute("mobile_no") Long mobile_no,@RequestParam("fname") String fname,@RequestParam("lname") String lname, @RequestParam("email") String email, @ModelAttribute("emp") TcashBean emp) {
	...
	public ModelAndView add(@ModelAttribute("mobile_no") Long mobile_no,@RequestParam("balance") float balance, @ModelAttribute("emp") TcashBean emp) {
	...
	public ModelAndView fundcheck(@ModelAttribute("mobile_no") Long mobile_no, @ModelAttribute("emp") TcashBean emp) {
		...
		if (dao.fund(mobile_no, emp) == true) {
			...
			ModelAndView modelAndView = new ModelAndView();
			modelAndView.addObject("mobile_no", mobile_no);
			String message=" Fund Transfered!";
